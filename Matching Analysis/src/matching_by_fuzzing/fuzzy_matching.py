...
if __name__ == "__main__":
    ...
    processed_data_dir = os.path.normpath(os.path.join(base_dir, '../../2024-05_school_mapping/solutions/solution 1/data/processed'))
    output_dir = os.path.normpath(os.path.join(base_dir, '../../../../2024-05_school_mapping/solutions/solution 1/results'))
