...
def get_fuzzy_match_score(row_a, row_b):
    ...
    school_level_b = row_b['school_level_old_name1_B']
    ...
    root_name_b = str(row_b['root_school_old_name1_B']) if pd.notna(row_b['root_school_old_name1_B']) else ''
...
def process_and_save_batch(start_idx, end_idx, batch_num, df_A, df_B, matched_ids_B, output_dir, df_all_matches, suffix):
    ...
    columns_to_keep = [
        'school_id_A','school_id_B', 'root_school_name_A','root_school_old_name1_B', 'school_level_A',  'school_level_old_name1_B',  'district_A',
        'district_B',
